...
fetch("../../csapatatos_munka/tree/CM-64/menu-rendszer/navbar.html") //Egy template -re hivatkozik, amiben a menü van
...
function ugras_a_kosar_oldalra() {
  window.location =
    "../../csapatatos_munka/tree/CM-64/bevasarlo-kosar/kosar.html";
}
