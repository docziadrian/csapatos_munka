  ...
  if (kosar.length !== 0) {
    let osszesen = kosar
      .map((x) => {
        ...
        return 1000 + filterData.price * item;
      })
      .reduce((x, y) => x + y, 0);
    ...
    return (label.innerHTML = `
       ...
       <div class="text-center">
          ...
          <br>
              <div class="text-center">
              <h5><input type="checkbox" id="aszf"> Elfogadom az <a target="_blank" href="/csapatos_munka/aszf/ASZF.pdf"><span id="aszf">ászf</a> </span>feltételeket <span id="jel"></span></h5>
